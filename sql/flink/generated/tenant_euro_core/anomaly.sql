...
SET 'pipeline.name' = 'tenant_euro_core-anomaly';

CREATE TABLE tenant_euro_core_anomaly_staging (
  ...
  'properties.group.id' = 'tenant_euro_core-anomaly',
  'scan.startup.mode' = 'earliest-offset',
  'format' = 'json'
);

CREATE TABLE tenant_euro_core_anomaly_mart (
  ...
  'connector' = 'kafka',
  'topic' = 'tenant_euro_core.mart_apm__fct_anomaly_events.v1',
  'properties.bootstrap.servers' = 'redpanda:19092',
  'format' = 'json'
);

INSERT INTO tenant_euro_core_anomaly_mart
SELECT
...
FROM tenant_euro_core_anomaly_staging
