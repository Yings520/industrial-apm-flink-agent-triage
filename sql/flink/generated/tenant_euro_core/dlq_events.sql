...
SET 'pipeline.name' = 'tenant_euro_core-dlq_events';

CREATE TABLE tenant_euro_core_dlq_events_raw_sensor_events (
  event_id STRING,
  event_time STRING,
  ingest_time STRING,
  ...
  'properties.group.id' = 'tenant_euro_core-dlq-events',
  'scan.startup.mode' = 'earliest-offset',
  'format' = 'json',
  'json.ignore-parse-errors' = 'true'
);

CREATE TABLE tenant_euro_core_dlq_events_sink (
  ...
  'connector' = 'kafka',
  'topic' = 'tenant_euro_core.raw_apm__dlq_events.v1',
  'properties.bootstrap.servers' = 'redpanda:19092',
  'format' = 'json'
);

INSERT INTO tenant_euro_core_dlq_events_sink
SELECT
  JSON_OBJECT(
...
FROM tenant_euro_core_dlq_events_raw_sensor_events
