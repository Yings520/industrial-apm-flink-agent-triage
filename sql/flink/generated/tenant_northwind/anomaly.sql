...
SET 'pipeline.name' = 'tenant_northwind-anomaly';

CREATE TABLE tenant_northwind_anomaly_staging (
  ...
  'properties.group.id' = 'tenant_northwind-anomaly',
  'scan.startup.mode' = 'earliest-offset',
  'format' = 'json'
);

CREATE TABLE tenant_northwind_anomaly_mart (
...
INSERT INTO tenant_northwind_anomaly_mart
SELECT
...
FROM tenant_northwind_anomaly_staging
