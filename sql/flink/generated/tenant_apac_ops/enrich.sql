...
SET 'pipeline.name' = 'tenant_apac_ops-enrich';

CREATE TABLE tenant_apac_ops_enrich_raw_sensor_events (
  ...
  'connector' = 'kafka',
  'topic' = 'tenant_apac_ops.raw_apm__sensor_readings.v1',
  'properties.bootstrap.servers' = 'redpanda:19092',
  'properties.group.id' = 'tenant_apac_ops-enrich',
  'scan.startup.mode' = 'earliest-offset',
  'format' = 'json'
);

CREATE TABLE tenant_apac_ops_enrich_cdc_tags (
  ...
  'properties.bootstrap.servers' = 'redpanda:19092',
  'properties.group.id' = 'tenant_apac_ops-enrich-cdc-tags',
  'scan.startup.mode' = 'earliest-offset',
  'format' = 'json'
);

CREATE TABLE tenant_apac_ops_enrich_cdc_assets (
  ...
  'properties.bootstrap.servers' = 'redpanda:19092',
  'properties.group.id' = 'tenant_apac_ops-enrich-cdc-assets',
  'scan.startup.mode' = 'earliest-offset',
  'format' = 'json'
);

CREATE TABLE tenant_apac_ops_enrich_cdc_comps (
  ...
  'properties.bootstrap.servers' = 'redpanda:19092',
  'properties.group.id' = 'tenant_apac_ops-enrich-cdc-comps',
  'scan.startup.mode' = 'earliest-offset',
  'format' = 'json'
);

CREATE TABLE tenant_apac_ops_enrich_staging_enriched (
  ...
  'topic' = 'tenant_apac_ops.staging_apm__sensor_readings.v1',
  'properties.bootstrap.servers' = 'redpanda:19092',
  'key.format' = 'json',
  'value.format' = 'json'
);

INSERT INTO tenant_apac_ops_enrich_staging_enriched
...
FROM tenant_apac_ops_enrich_raw_sensor_events r
LEFT JOIN tenant_apac_ops_enrich_cdc_tags m
  ON r.tenant_id = m.tenant_id AND r.tag_id = m.tag_id
LEFT JOIN tenant_apac_ops_enrich_cdc_assets a
  ON m.tenant_id = a.tenant_id AND m.asset_id = a.asset_id
LEFT JOIN tenant_apac_ops_enrich_cdc_comps c
  ON m.tenant_id = c.tenant_id AND m.asset_id = c.asset_id AND m.component_id = c.component_id
WHERE r.tenant_id = 'tenant_apac_ops'
