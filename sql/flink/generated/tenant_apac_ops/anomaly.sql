...
SET 'pipeline.name' = 'tenant_apac_ops-anomaly';

CREATE TABLE tenant_apac_ops_anomaly_staging (
  ...
  'properties.group.id' = 'tenant_apac_ops-anomaly',
  'scan.startup.mode' = 'earliest-offset',
  'format' = 'json'
);

CREATE TABLE tenant_apac_ops_anomaly_mart (
  ...
  'connector' = 'kafka',
  'topic' = 'tenant_apac_ops.mart_apm__fct_anomaly_events.v1',
  'properties.bootstrap.servers' = 'redpanda:19092',
  'format' = 'json'
);

INSERT INTO tenant_apac_ops_anomaly_mart
SELECT
...
FROM tenant_apac_ops_anomaly_staging
