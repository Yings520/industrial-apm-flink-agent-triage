-- ClickHouse smoke query template. Replace tenant_apac_ops before execution.
-- Usage: sed "s/\tenant_apac_ops/tenant_northwind/g" query.sql.tpl | clickhouse-client -mn
