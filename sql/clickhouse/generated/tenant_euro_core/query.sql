-- ClickHouse smoke query template. Replace tenant_euro_core before execution.
-- Usage: sed "s/\tenant_euro_core/tenant_northwind/g" query.sql.tpl | clickhouse-client -mn
