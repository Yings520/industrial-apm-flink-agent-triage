...
--
-- Placeholders:
--   ${tenant_id}      - Tenant identifier (used ONLY in DWD section; omit for CDC DIM)
...
-- Usage: sed "s/\${tenant_id}/<YOUR_TENANT>/g; s/\${source_topic}/.../g; ..." kafka_ingest.sql.tpl | clickhouse-client -mn
-- ============================================================
...
--   ${source_topic}   = ${tenant_id}.staging_apm__sensor_readings.v1
--   ${target_table}   = dwd_apm_realtime_signal_readings
--   ${consumer_group} = ch_${tenant_id}_dwd_realtime_signal_readings
...
--   ${tenant_id}      = <YOUR_TENANT>
--   ${source_topic}   = ${tenant_id}.mart_apm__fct_anomaly_events.v1
--   ${target_table}   = dwd_apm_anomaly_events
--   ${consumer_group} = ch_${tenant_id}_dwd_anomaly_events
...
--   ${tenant_id}      = <YOUR_TENANT>
--   ${source_topic}   = ${tenant_id}.mart_apm__fct_late_sensor_readings.v1
--   ${target_table}   = dwd_apm_late_sensor_readings
--   ${consumer_group} = ch_${tenant_id}_dwd_late_sensor_readings
...
--   ${tenant_id}      = <YOUR_TENANT>
--   ${source_topic}   = ${tenant_id}.mart_apm__fct_stream_health_snapshots.v1
--   ${target_table}   = dwd_apm_stream_health_snapshots
--   ${consumer_group} = ch_${tenant_id}_dwd_stream_health_snapshots
...
--   ${tenant_id}      = <YOUR_TENANT>
--   ${source_topic}   = ${tenant_id}.mart_apm__fct_realtime_diagnosis_events.v1
--   ${target_table}   = dwd_apm_realtime_diagnosis_events
--   ${consumer_group} = ch_${tenant_id}_dwd_realtime_diagnosis_events
...
--   ${tenant_id}      = <YOUR_TENANT>
--   ${source_topic}   = ${tenant_id}.raw_apm__dlq_events.v1
--   ${target_table}   = dwd_apm_dlq_events
--   ${consumer_group} = ch_${tenant_id}_dwd_dlq_events
